...
<nav class="navbar navbar-inverse">
	...
	<h2 class="text-center">Administration Portal - List of Academies</h2>
 	<div style="padding-top:120px; padding-left:300px">
	<table class="demotbl">
		
		<tr>
			<td style="background-color:#00bfff; color: Black"><b>ACADEMY ID</b></td>
			<td style="background-color:#00bfff; color: Black"><b>ACADEMY NAME</b></td>
			<td style="background-color:#00bfff; color: Black"><b>ACADEMY LOCATION</b></td>
		</tr>
		<c:forEach var="adv" items="${acList}">
			<tr>
				<td style="color: Black; background-color:White">${adv.academyID}</td>
	...
	<div style="padding-top: 190px; padding-left:2px" >
