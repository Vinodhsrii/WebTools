...
<body>
	...
	<h2 class="text-center">Service Portal - List of Available Slots</h2>
...
<%-- 						<td style="color: Black; background-color: White">${adv.slotID}</td> --%>
						...
						<td style="color: Red"><a href="${pageContext.request.contextPath}/serviceprovider/update?spID=${adv.spID}&avail=${adv.availability}&price=${adv.price}">Delete</a></td>
					</tr>
				</c:forEach>
			</table>
		</form>
