...
body {
	background-image:
		...
		url("http://buzaul-sportiv.ro/wp-content/uploads/2016/08/Grass-Textures-for-Designers8.jpg");
...
<body>
	<nav class="navbar navbar-inverse">
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<div style="padding-top: 5px">
					<ul>
						<li><a href="${contextPath}"><button type="button" class="btn btn-primary navbar-right">Go Back</button></a></li>
					</ul>
				</div>
			</div>			
		</div>
		...
		<div style="padding-top: 120px; padding-left: 400px; color: Red">
			<h2>${errorMessage}</h2>
		</div>
